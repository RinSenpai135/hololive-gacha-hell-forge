...
public class GlowstoneWireBlock extends Block {
	...
	public GlowstoneWireBlock(AbstractBlock.Properties p_i48344_1_) {
      	super(p_i48344_1_);
	...
	private BlockState getConnectionState(IBlockReader p_235544_1_, BlockState p_235544_2_, BlockPos p_235544_3_) {
		...
		if (flag && isDot(p_235544_2_)) {
			...
			if (!flag4 && flag5) { p_235544_2_ = p_235544_2_.setValue(WEST, RedstoneSide.SIDE);	}
	
			if (!flag3 && flag5) { p_235544_2_ = p_235544_2_.setValue(EAST, RedstoneSide.SIDE);	}
	
			if (!flag1 && flag6) { p_235544_2_ = p_235544_2_.setValue(NORTH, RedstoneSide.SIDE); }
	
			if (!flag2 && flag6) { p_235544_2_ = p_235544_2_.setValue(SOUTH, RedstoneSide.SIDE); }
	...
	public BlockState updateShape(BlockState p_196271_1_, Direction p_196271_2_, BlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
		if (p_196271_2_ == Direction.DOWN) { return p_196271_1_; } 
